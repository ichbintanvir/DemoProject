    ...
    return (
        <div className="container mx-auto sm:px-5">
            <div className="text-center pt-24">
                <h1 className="font-bold text-xl sm:text-6xl" data-aos="fade-up" data-aos-duration="1000">Powered to drive optimal results</h1>
                <p className="pt-4 text-sm sm:text-lg" data-aos="fade-up" data-aos-duration="2000">Brands & app marketers can find tailor made solutions to reach your end user.</p>
            </div>
            <div className="pt-14 pb-24 grid grid-cols-1 space-y-4 pl-8 sm:grid-cols-3">
                <div className="text-center w-72 mx-auto" data-aos="fade-up" data-aos-duration="3000">
